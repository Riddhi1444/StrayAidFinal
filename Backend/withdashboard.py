...
svm_model = joblib.load("C:/Users/rsdan/OneDrive/Desktop/StrayAid/Backend/injury_classification_svm.pkl")
...
def dashboard():
    ...
    # Reverse the cases so latest are on top
    cases.reverse()
...
def trigger_scripts():
    try:
        # Run nlp.py
        subprocess.Popen(["python", "C:/Users/rsdan/OneDrive/Desktop/StrayAid/Backend/nlp.py"])
        # Run whatsapp.py
        subprocess.Popen(["python", "C:/Users/rsdan/OneDrive/Desktop/StrayAid/Backend/whatsapp.py"])
